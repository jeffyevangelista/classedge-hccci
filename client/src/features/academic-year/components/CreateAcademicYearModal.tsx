...
import { useCreateAcademicYear } from "../academic-year.hooks";
...
const CreateAcademicYearModal = () => {
  ...
  const {
    mutateAsync: createAcademicYear,
    isPending,
    isError,
    error,
  ...
  return (
    <Dialog open={open} onOpenChange={handleDialogChange}>
      <Tooltip open={tooltipOpen} onOpenChange={setTooltipOpen}>
        ...
        <TooltipContent>Create a new academic year</TooltipContent>
      </Tooltip>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <form onSubmit={handleSubmit(onSubmit)}>
          <DialogHeader>
            ...
            <DialogDescription>
              Provide a name and date range for the new academic year.
            </DialogDescription>
          </DialogHeader>
